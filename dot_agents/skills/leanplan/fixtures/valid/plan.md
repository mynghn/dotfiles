...
**Goal**: Add anomaly publisher per `SPEC#AC-1-anomaly-visible`, realized by `DESIGN#Decision-1-async-publisher`.

**Repo**: `services/reservation`

**Completion criteria**:
- Publisher emits anomaly for `SPEC#AC-1-anomaly-visible`.
...
**Completion criteria**:
- Detection path emits anomaly for `SPEC#AC-1-anomaly-visible`.
