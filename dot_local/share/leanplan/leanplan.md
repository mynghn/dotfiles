...
> Runtime canonical at `~/.local/share/leanplan/leanplan.md`, applied via chezmoi. The in-repo source-of-truth lives at `carsharing-backend/docs/leanplan.md` (authored there). For personal-phase use, edit the in-repo copy and re-sync into chezmoi source.
